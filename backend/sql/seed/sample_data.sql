...
-- ----------------------------------------------------------------------------
-- Note: admitted_by references staff_id. Adjust based on your staff records.
-- Assuming staff_id 1 is admin, staff_id 2 is doctor, staff_id 3 is nurse.

INSERT INTO admissions (patient_id, admitted_at, status, admitted_by, discharge_notes) VALUES
    (1, NOW() - INTERVAL 2 DAY, 'admitted', 2, NULL),
    (2, NOW() - INTERVAL 1 DAY, 'admitted', 2, NULL),
    (3, NOW() - INTERVAL 3 DAY, 'admitted', 2, NULL);
...
INSERT INTO device_assignments (device_id, patient_id, assigned_from, assigned_by, notes) VALUES
    (1, 1, NOW() - INTERVAL 2 DAY, 3, 'Initial device assignment for patient monitoring'),
    (2, 2, NOW() - INTERVAL 1 DAY, 3, 'Device assigned for continuous monitoring'),
    (3, 3, NOW() - INTERVAL 3 DAY, 3, 'Long-term monitoring setup');
